...
function SvgPhotoIcon(props: SvgProps) {
  return (
    <Svg width={25} height={25} fill="transparent" {...props}>
      <G id="heroicons-outline/photo" clipPath="url(#clip0_3136_973)">
        <Path
          id="Vector (Stroke)"
          fillRule="evenodd"
          clipRule="evenodd"
